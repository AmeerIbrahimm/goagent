...
[![Go Report Card](https://goreportcard.com/badge/github.com/AmeerIbrahimm/goagent/instrumentation/otelsql)](https://goreportcard.com/report/github.com/AmeerIbrahimm/goagent/instrumentation/otelsql)
[![GoDevDoc](https://img.shields.io/badge/dev-doc-00ADD8?logo=go)](https://pkg.go.dev/github.com/AmeerIbrahimm/goagent/instrumentation/otelsql)
...
> ⚠️ From `v0.5.0`, the project is rebranded to `github.com/AmeerIbrahimm/goagent/instrumentation/otelsql`. `v0.4.x` is the last version with `github.com/nhatthm/otelsql`.

```bash
go get github.com/AmeerIbrahimm/goagent/instrumentation/otelsql
```
