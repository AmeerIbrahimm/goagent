module github.com/AmeerIbrahimm/goagent/instrumentation/otelsql/tests/suite
...
require (
	...
	github.com/AmeerIbrahimm/goagent/instrumentation/otelsql v0.1.0
...
replace github.com/AmeerIbrahimm/goagent/instrumentation/otelsql => ../../
